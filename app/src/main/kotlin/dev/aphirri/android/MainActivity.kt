...
import dev.aphirri.android.core.navigation.models.toRoute
...
import dev.aphirri.android.features.bottombar.bottombar_ui.AphirriBottombar
import dev.aphirri.android.features.home.home_ui.navigation.homeDestination
import dev.aphirri.android.features.meetings.meetings_ui.navigation.meetingsDestination
import dev.aphirri.android.features.meetings.meetings_ui.navigation.servicesDestination
import dev.aphirri.android.features.meetings.meetings_ui.navigation.storageDestination
import dev.aphirri.android.ui.splash.setupSplashScreen
...
fun GreetingPreview() {
    AphirriTheme {
        Scaffold(
            ...
            containerColor = AphirriTheme.colors.background,
            bottomBar = {
                AphirriBottombar(navController = rememberNavController())
            },
        ) { innerPadding ->
            AphirriToolbar(
